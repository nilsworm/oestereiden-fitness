  ...
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center">
      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center gap-6 rounded-3xl border border-white/20 bg-white/20 backdrop-blur-xl p-10 shadow-2xl">
        ...
        <Link
          href="/registration"
          className="w-full rounded-xl border border-white/30 bg-white/25 backdrop-blur-sm px-4 py-2.5 text-center text-sm font-medium text-white shadow-lg [text-shadow:0_1px_3px_rgba(0,0,0,0.4)] transition-colors hover:bg-white/35"
        >
          Zur Startseite
        </Link>
      </div>
